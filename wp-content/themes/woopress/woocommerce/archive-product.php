...
<div class="<?php echo (!$full_width) ? 'container' : 'shop-full-width'; ?>">
	<div class="page-content sidebar-position-<?php echo esc_attr( $l['sidebar'] ); ?> <?php if (etheme_get_option('grid_sidebar') != 'without'): ?> sidebar-mobile-<?php esc_attr_e( $l['shop-sidebar-mobile'] ); ?> <?php endif; ?>">
		<div class="row">
			...
			<?php if(!$full_width) : ?>
				<?php if ( etheme_get_option('shop_sidebar_responsive_display') && etheme_get_option('grid_sidebar') != 'without' && etheme_get_option('prodcuts_per_row') < 6) : ?> 
				...
				<?php get_sidebar('shop'); ?> 
					<?php if ( etheme_get_option('shop_sidebar_responsive_display') && etheme_get_option('grid_sidebar') != 'without' && etheme_get_option('prodcuts_per_row') < 6) echo '</div>'; ?>
				<?php endif; ?> 
