			...
			<div id="loginModal" class="modal hide fade" tabindex="-1" role="dialog" aria-hidden="true">
				<div>
					<div class="modal-header">
						...
						<h3 class="title"><span><?php esc_html_e('Login', 'woopress'); ?></span></h3>
					</div>
					<div class="modal-body">
						...
						<form method="post" class="login">
							...
							<p class="form-row">
								...
								<input type="submit" class="button filled active" name="login" value="<?php esc_html_e( 'Login', 'woopress' ); ?>" />
								<a class="lost_password" href="<?php echo esc_url( wc_lostpassword_url() ); ?>"><?php esc_html_e( 'Lost Password?', 'woopress' ); ?></a>
								<a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>" class="right"><?php esc_html_e('Create Account', 'woopress') ?></a>
							</p>
						</form>
					</div>
				</div>
                ...
                ?>
					<li class="woocommerce-mini-cart-item <?php echo esc_attr( apply_filters( 'woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key ) ); ?>">
						<?php 
							...
							sprintf('<a href="%s" data-product_id="%s" data-cart_item_key="%s" data-product_sku="%s"class="close-order-li remove remove_from_cart_button" title="%s"></a>', esc_url( WC()->cart->get_remove_url( $cart_item_key ) ), esc_attr( $product_id ),esc_attr ( $cart_item_key ), esc_attr( $_product->get_sku() ),esc_html__('Remove this item', 'woopress') ), 
                            	$cart_item_key ); 
                        ?>
						<div class="media">
