            ...
            <ul>
                <?php
                    foreach ($terms as $term) {
                        ...
                        ?>
                            <li>
                                <a href="<?php echo get_term_link( $term ); ?>" title="<?php esc_html_e('View all products from ', 'woopress'); echo $term->name; ?>"><?php if($curr) echo '<strong>'; ?><?php echo $term->name; ?><?php if($curr) echo '</strong>'; ?></a>
                            </li>
                        <?php
                    }
                ?>
...
class null_instagram_widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array('classname' => 'null-instagram-feed', 'description' => esc_html__('Displays your latest Instagram photos', 'woopress') );
		parent::__construct('null-instagram-feed', esc_html__('Instagram', 'woopress'), $widget_ops);
	}
	...
	function form($instance) {
		$instance = wp_parse_args( (array) $instance, array( 'title' => esc_html__('Instagram', 'woopress'), 'username' => '', 'link' => esc_html__('Follow Us', 'woopress'), 'number' => 9, 'size' => 'thumbnail', 'target' => '_self', 'info' => false, 'slider' => false) );
			...
			switch ( $type ) {
				...
				default:
					foreach ( $images as $image ) {
						...
						$caption = esc_html__( 'Instagram Image', 'woopress' );
