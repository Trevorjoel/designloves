 ...
 * @package shopstar
 */
define( 'SHOPSTAR_THEME_VERSION' , '1.0.29' );
...
function shopstar_adjust_content_width() {
    ...
    if ( is_page_template( 'template-full-width.php' ) ) {
		...
		$content_width = 1140;
	} else if ( $is_woocommerce && get_theme_mod( 'shopstar-layout-woocommerce-shop-full-width', customizer_library_get_default( 'shopstar-layout-woocommerce-shop-full-width' ) ) ) {
		$content_width = 1140;
